...
const Signup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            // Sending registration data to Flask backend
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 font-sans">
            <div className="bg-white p-10 rounded-[2.5rem] shadow-2xl w-full max-w-md border border-slate-100 transition-all hover:shadow-blue-50">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <select 
                                className="w-full p-4 bg-slate-50 border border-slate-100 rounded-2xl outline-none focus:ring-2 focus:ring-blue-500 text-sm font-medium appearance-none cursor-pointer"
                    ...
                    <button 
                        ...
                        className={`w-full py-4 rounded-2xl text-white font-black text-xs tracking-widest shadow-xl transition-all uppercase ${
                            loading ? 'bg-slate-300 animate-pulse' : 'bg-slate-900 hover:bg-black shadow-slate-200 active:scale-95'
                        }`}
                    >
